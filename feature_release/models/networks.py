...
# Abandoned this impelementation in favour of the new implementation - AA, 10/07/2020
...
#         # relu3_3 = h
#         if opt.vgg16_choose != "no_maxpool":
#             h = F.max_pool2d(h, kernel_size=2, stride=2)
...
#         relu5_3 = h
#         if opt.vgg16_choose == "conv4_3":
#             return conv4_3
#         elif opt.vgg16_choose == "relu4_2":
#             return relu4_2
#         elif opt.vgg16_choose == "relu4_1":
#             return relu4_1
#         elif opt.vgg16_choose == "relu4_3":
#             return relu4_3
#         elif opt.vgg16_choose == "conv5_3":
#             return conv5_3
#         elif opt.vgg16_choose == "relu5_1":
#             return relu5_1
#         elif opt.vgg16_choose == "relu5_2":
#             return relu5_2
#         elif opt.vgg16_choose == "relu5_3" or "maxpool":
#             return relu5_3
...
#         print('Pre-trained VGG16 checkpoint missing!')
#         raise Exception
#     vgg = Vgg16()
...
# New implementation - AA, 10/07/2020
