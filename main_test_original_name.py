from DCShadowNet_test_original_name import DCShadowNet
import argparse
...
def parse_args():
    ...
    parser.add_argument('--im_suf_A', type=str, default='.jpg')
    #parser.add_argument('--im_suf_A', type=str, default='.png')
